...
public class QueuedMessageConnectorService extends AbstractConnectorService {

	private boolean connected = false;

	public QueuedMessageConnectorService(IHost host) {
		super("QueuedMessageConnectorService", null, host, 0);
	}
